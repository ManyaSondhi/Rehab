...
function checkAuthStatus() {
    ...
    if (user) {
        ...
        if (currentPage === '/login' || currentPage === '/signup' || currentPage === '/role-selection' || currentPage === '/') {
        ...
        if ((currentPage === '/user-dashboard' || currentPage === '/my-exercises' || currentPage === '/user-game') && user.role !== 'patient') {
            window.location.href = '/doctor-dashboard';
        }
        
        if ((currentPage === '/doctor-dashboard' || currentPage === '/patient-details') && user.role !== 'therapist') {
            window.location.href = '/home';
        }
    }
}
...
function updateNavbarForLoggedInUser(user) {
    ...
    dashboardLink.innerHTML = `<a href="${user.role === 'patient' ? '/user-dashboard' : '/doctor-dashboard'}">Dashboard</a>`;
    ...
    if (user.role === 'patient') {
        communicationLink.innerHTML = `<a href="/communication">Communication</a>`;
    } else {
